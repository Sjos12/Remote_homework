        ...
        >
            ...
            <div class="container">
                <a class="navbar-brand" href="{{ route('home') }}">
                    <img
                        id="logo"
                        src="{{ asset('images/remote_homework_logo.png') }}"
                        alt="Logo"
                        style="width: 130px"
                    />
                </a>
                        ...
                        <li class="nav-item dropdown d-flex">
                            <div
                                class="
                                    ...
                                    profilepicture-container--nav
                                    shadow
                                    ml-4
                                "
                            >
                                <img
                                    src="{{ \Illuminate\Support\Facades\Auth::user()->getFirstMediaUrl('profiles') }}"
                                    class="h-100"
                                    alt=""
                                />
                            </div>
