    ...
    <div class="row">
        ...
        <div class="row">
            <div class="col-12 mr-auto ml-auto pt-4">
                    <button type="button" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Places a texbox on the middle of the image" onclick="spawntext()">
                    ...
                    <button type="button" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Places a resizable circle on the middle of the image" onclick="spawncircle()">
                    ...
                    <button type="button" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Places a straight line on the middle of the image" onclick="spawncircle()">
                    ...
                    <button type="button" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Places an arrow on the middle of the image" onclick="spawncircle()">
                    ...
                    <button type="button" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Places an arrow on the middle of the image" onclick="spawncube()">
                        {{ __('RECT') }}
                    </button>
