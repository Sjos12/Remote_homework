        ...
        <!--@todo: on the caret click, the question should pop down and the paragraph should preview as well as the image which should grow larger-->
            <div class="col-10 offset-1">
                <div class="row">
                    ...
                    <div class="col-2">
                        <a class="float-right collapsible" type="button" href="#"></a>
            ...
            <div class="row">
                <div class="toolbar  mx-auto">
                    ...
                    <div class="float-right">
                        ...
                        <button class="btn" onclick="resetZoom()" type="button">Reset Zoom</button>

                </div>
            </div>
        </div>
    </div>
    <canvas class="mt-4 border border-light"
            id="canvas"
            width="onresize()"
            data-image-info="{{ json_encode($firstImageInfo, JSON_THROW_ON_ERROR) }}"
    >
