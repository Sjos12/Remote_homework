...
<div class="container pb-5">
    <div class="card mb-5">
        <div class="originalquestion p-3 col-12 ">
    ...
    <div class="card  pb-5">
        ...
        <div class="row">
            <div class="toolbar mr-auto ml-auto ">
                <button type="button" class="btn" data-toggle="tooltip" data-placement="top" title="Places a texbox on the middle of the image" onclick="spawntext()">
                ...
                <button type="button" class="btn" data-toggle="tooltip" data-placement="top" title="Places a resizable circle on the middle of the image" onclick="spawncircle()">
                ...
                <button type="button" class="btn" data-toggle="tooltip" data-placement="top" title="Places a straight line on the middle of the image" onclick="spawncircle()">
                ...
                <button type="button" class="btn" data-toggle="tooltip" data-placement="top" title="Places an arrow on the middle of the image" onclick="spawncircle()">
                ...
                <button type="button" class="btn" data-toggle="tooltip" data-placement="top" title="Places an arrow on the middle of the image" onclick="spawncube()">
                    {{ __('RECT') }}
                </button>
